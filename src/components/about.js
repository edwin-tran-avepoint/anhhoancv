  ...
  return (
    <div className='container p-5 flex flex-col'>
      <div className='block w-full p-6 bg-white border border-gray-200 rounded-lg shadow space-y-10'>
        ...
        <div className='block'>
          <div className='font-extrabold text-xl text-gray-900'>EDUCATION</div>
          <p className='font-bold'>2015-2020</p>
          <p className='font-bold text-lg'>DA NANG UNIVERSITY OF SCIENCE & TECHNOLOGY</p>
          <p>
